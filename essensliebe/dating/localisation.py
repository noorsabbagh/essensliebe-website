...
class Loc:
    def __init__(self):
        ...
        self.geolocator = Nominatim(user_agent='app_demo')
        # google places api key
        self.api_key = 'AIzaSyCXmfyVfwPypP1HwUnVE1LMKbqqz6heipk'
    ...
    def address_to_geolocation(self,address):
    ...
    def radius_calc(self, address1,address2): 
        my_dist = self.distance_calc(address1,address2)
    ...
    def distance_calc(self,address1,address2): 
    ...
    def bearing_calc(self,lat1,lon1,lat2,lon2):
    ...
    def centre_point_calc(self,lt1,ln1,b,d):
        point = Geo((lt1, ln1))
    ...
    def find_nearby_places(self,lat, lon, radius):
    ...
    def find_restaurants(self,lat, lon, rad):
