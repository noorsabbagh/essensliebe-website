...
class UserResponseForm(forms.Form):
    ...
    def clean_question_id(self):
        ...
        try:
            ...
            raise forms.ValidationError('There was an error with the question. Please retry.')
        return question_id
    ...
    def clean_answer_id(self):
        ...
        try:
            ...
            raise forms.ValidationError('There was an error with the answer. Please retry.')
        return answer_id
    ...
    def clean_their_answer_id(self):
        ...
        try:
            ...
            if their_answer_id == -1:
                ...
                raise forms.ValidationError('There was an error with the answer you have provided for them. Please retry.')
        return their_answer_id
